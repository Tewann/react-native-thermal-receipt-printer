...
//    private int[] PRINTER_ON_PORTS = {515, 3396, 9100, 9303};
    ...
    @Override
    public void printRawData(String rawBase64Data, Callback sucessCallback, Callback errorCallback) {
        if (this.mSocket == null) {
        ...
        final Callback errorCall = errorCallback;
        final Callback succesCall = sucessCallback;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    errorCall.invoke(LOG_TAG, "failed to print data" + rawData);
